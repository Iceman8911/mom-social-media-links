...
function SocialMediaHandle(props: {
  socialMedia: "whatsapp" | "telegram";
  link: string;
}) {
  return (
    <button class="btn btn-primary rounded-lg w-[75vw] sm:w-100 h-16 grid [grid-template-columns:25%_1fr] gap-4 font-bold *:flex *:items-center *:w-full *:h-full">
